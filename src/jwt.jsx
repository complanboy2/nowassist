                  ...
                  <>
                    ...
                    <div className="absolute right-0 top-full mt-2 w-40 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl z-50 overflow-hidden">
                      ...
                      <button
                        ...
                        className={clsx('w-full px-4 py-2.5 text-left text-sm transition-colors border-b border-gray-100 dark:border-gray-700 last:border-b-0 focus:outline-none', currentCompany === 'salesforce' ? 'bg-sky-50 dark:bg-sky-900/30 text-sky-700 dark:text-sky-300 font-semibold' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700')}
                        tabIndex={0}
                      >
                        Salesforce
                      </button>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <div className="flex flex-wrap items-center gap-2">
                  ...
                  <button
                    ...
                    tabIndex={0}
                  >
                    <X className="h-3.5 w-3.5 text-gray-600 dark:text-white" />
                    Clear
                  </button>
                </div>
              </div>
              ...
              {token && (
                <div className="absolute inset-0 pointer-events-none px-3 sm:px-5 py-3 sm:py-4 font-mono text-xs sm:text-sm leading-relaxed overflow-hidden rounded-xl" style={{ maxHeight: '400px', overflowY: 'auto' }}>
                  <pre className="whitespace-pre-wrap break-all">
                    {(() => {
                      const parts = token.split('.');
                      if (parts.length !== 3) return <span className="text-gray-900 dark:text-gray-100">{token}</span>;
                      return (
                        <>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex items-center gap-0.5 bg-white dark:bg-gray-700 p-0.5 border border-gray-300 dark:border-gray-600 rounded-md">
                        ...
                        <button
                          ...
                          className={clsx('px-2 py-1 text-xs font-medium transition-colors rounded inline-flex items-center gap-1', payloadViewMode === 'table' ? 'bg-sky-500 text-white' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600')}
                          tabIndex={0}
                        >
